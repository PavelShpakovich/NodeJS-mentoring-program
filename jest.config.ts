...
export default {
  ...
  // cacheDirectory: "/private/var/folders/ln/k2t0487n0h3ggpxn548x2z_h0000gn/T/jest_dx",
  ...
  collectCoverageFrom: ['src/**/*.ts', '!**/node_modules/**', '!src/**/*.types.ts', '!src/server.ts', '!src/app.ts'],
