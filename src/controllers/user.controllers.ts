...
export const createUser = (users: IUser[]) => {
    return (req: ValidatedRequest<RequestSchema>, res: Response) => {
...
export const getUsers = (users: IUser[]) => {
    return (req: Request<{}, {}, {}, QueryParams>, res: Response) => {
...
export const getUser = (users: IUser[]) => {
...
export const updateUser = (users: IUser[]) => {
    return (req: ValidatedRequest<RequestSchema>, res: Response) => {
        const id = req.params.id;
        const { login, password, age } = req.body;
        users.forEach((u) => {
